        ...
        Iterable<StreamedChatResponse> response =
                cohere.chatStream(
                        ChatStreamRequest.builder()
                                ...
                                .chatHistory(
                                        List.of(
                                                Message.chatbot(ChatMessage.builder().message("Who discovered gravity?").build()),
                                                Message.user(ChatMessage.builder().message("The man who is widely credited"
                                                        + " with discovering gravity is"
                                                        + " Sir Isaac Newton").build())))
                                .build());
