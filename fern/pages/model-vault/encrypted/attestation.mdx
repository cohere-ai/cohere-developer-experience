...
- **Available through the API**: verification is not limited to the Model Vault app. Every inference response can include an attestation certificate that your client can check programmatically, confirming proof of the policy, CPU, GPU, and software before you trust a response.
