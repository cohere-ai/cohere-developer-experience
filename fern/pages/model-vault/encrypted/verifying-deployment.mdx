...
The verification that actually protects your data is **automatic and client-side**: the TNG client or
...
the client-side TNG check, which binds the attestation to the OHTTP key it encrypts to on every
