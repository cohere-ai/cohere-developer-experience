...
name**. See [Calling a Vault over the API](/docs/model-vault/api-access).
...
automatically before sending any data, and fails closed if it does not pass. You can also inspect the
attestation results, the CPU, GPU, software, and policy checks, in the dashboard or through the API,
