...
You must acknowledge Cohere’s [SaaS Agreement](https://cohere.ai/saas-agreement) and [Terms of Service](https://cohere.ai/terms-of-use). Your organization must also read and recognize our [Model Limitations](/docs/model-limitations), [Model Cards](/docs/generation-card), and [Data Statement](/docs/data-statement).
