...
[large language models](../docs/the-cohere-platform#large-language-models-llms) (LLMs) with just a few 
...
[agents](../docs/multi-step-tool-use). If you have a more specialized use case and custom data, you can 
also [train a custom model](../docs/fine-tuning) to get better performance.

Check out [our documentation](../docs/the-cohere-platform) if you're ready to start building, and you 
might want to check out our [API pricing](../docs/rate-limits).
