...
[Amazon Bedrock](http://docs.aws.amazon.com/bedrock) is a fully managed service where foundational models from Cohere and other LLM providers are made available through a single, serverless API.
