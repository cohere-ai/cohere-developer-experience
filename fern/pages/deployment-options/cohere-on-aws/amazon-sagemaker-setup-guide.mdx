...
# Invoke the model and print the response
results = co.rerank(
    model="<YOUR RERANK-V4.0 ENDPOINT NAME>", #eg, pro: arn:aws:sagemaker:us-west-2:455073351313:model-package/cohere-rerank-v4-0-pro-v1-0, fast: arn:aws:sagemaker:us-west-2:455073351313:model-package/cohere-rerank-v4-0-fast-v1-0
    query=query,
    documents=docs,
    top_n=2,
)
