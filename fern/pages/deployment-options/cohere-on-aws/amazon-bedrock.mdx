...
You can use this code to invoke Cohere’s Embed v4.0 model on Amazon Bedrock:
...
model_id = "cohere.embed-v4"  # or "cohere.embed-multilingual-v3" or "cohere.embed-english-v3"
