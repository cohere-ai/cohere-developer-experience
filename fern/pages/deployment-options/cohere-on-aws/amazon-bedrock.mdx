...
hidden: false
description: "This document provides prerequisites for using Cohere's models on Amazon Bedrock, including subscribing to the models, installing the AWS Python SDK, and configuring authentication credentials. It also includes code snippets to invoke Cohere's embed and text generation models using Bedrock."
