...
hidden: false
description: "This document provides instructions on how to pull Cohere's container images using a license and test them with Docker and Kubernetes. It also includes examples of running different Cohere models in Docker containers."
