...
- [Text Generation (Command model)](https://docs.cohere.com/v1/docs/text-gen-quickstart)
- [RAG (Command model)](https://docs.cohere.com/v1/docs/rag-quickstart)
- [Tool Use (Command model)](https://docs.cohere.com/v1/docs/tool-use-quickstart)
- [Semantic Search (Embed model)](https://docs.cohere.com/v1/docs/sem-search-quickstart)
- [Reranking (Rerank model)](https://docs.cohere.com/v1/docs/reranking-quickstart)
