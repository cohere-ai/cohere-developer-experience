...
The core motivation for developing safety modes is an acknowledgement that safety and appropriateness are context-dependent, and that this predictability and control are critical in building confidence in Cohere models.

## Why 

Traditionally, safety guardrails are reactive and binary. For its part, Safe Content Modes introduce a nuanced approach that is context sensitive. 
