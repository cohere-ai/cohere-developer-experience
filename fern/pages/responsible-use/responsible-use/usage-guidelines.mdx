...
Our Usage Policy applies to all Cohere products and services, including Cohere AI models, software, applications, and application programming interface (collectively *“Cohere Services”*). 
...
If we learn that you have violated this Usage Policy or are otherwise misusing or abusing Cohere Services, we are entitled to restrict, suspend, or terminate your access to the Cohere Services. If you become aware of a violation of this Usage Policy, including by any Outputs, you are required to notify us at safety@cohere.com. If you are using the Cohere Services in our SaaS Platform, you can also report issues by using the thumbs down button on an Output.  “Outputs” means any information, text, image, audio or video content artificially created by Cohere Services.
...
- **Child Sexual Exploitation and Sexually Explicit Content Involving Minors**. Any activity that, whether intentionally or not, exploits, abuses, or endangers children, or otherwise compromises the safety of children; or any generation, creation, sharing, or facilitation of sexually explicit content involving minors, including pornographic content or content intended for sexual arousal or gratification. We will report child sexual abuse material that comes to our attention to competent authorities and other organizations as appropriate.
...
- **Illegal Activities.** Any illegal activity, or other violation of any applicable law, including providing instructions on how to commit crimes, facilitating illegal activities or intentionally generating Outputs that may infringe, violate, or misappropriate, the intellectual property rights, including copyrights, of a third party.
- **Weapons and Controlled Substances.** Any activities that relate to the production, sale, trafficking, or marketing of (1) weapons (or their components), including chemical, biological, radiological, nuclear weapons; or (2) controlled substances.
...
- **Fraudulent, Abusive, Misleading, or Deceptive Practices.** Use of the Cohere Services to (1) generate inauthentic content representing existing persons, places, entities, events, or objects that could falsely appear as authentic or truthful (so-called “deep fakes”) or as having been created by a human (e.g., fake reviews) in a manner that is misleading, deceiving or harmful to individuals, groups, or entities; (2) engage in academic dishonesty; or (3) deploy subliminal or purposefully deceptive or manipulative techniques in products, campaigns, services or business models to exploit vulnerabilities such as age, socio-economic status, or disability; or to distort behaviour or impair decision-making, including exploitative lending or debt collection practices, misleading advertising, or high-pressure sales tactics.
