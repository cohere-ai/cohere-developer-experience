...
- Under `Advanced Parameters`, you can customize the `temperature` and `seed`. A higher temperature will make the model more creative, while a lower temperature will make the model more focused and deterministic, and seed can help you keep outputs consistent. Learn more in the [How to Get Predictable Outputs with Cohere Models](https://docs.cohere.com/docs/predictable-outputs) section.
