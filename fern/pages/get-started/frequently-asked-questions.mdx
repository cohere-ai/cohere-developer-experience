...
Cohere’s Command models have strong performance across enterprise tasks such as summarization, multilingual use cases, and retrieval augmented generation. We also have the widest range of deployment options, you can check our [deployment options](https://cohere.com/deployment-options) page.
...
You can find a full list of languages that are supported by Cohere’s multilingual embedding model on the [Supported Languages](https://docs.cohere.com/docs/supported-languages) page.

</Accordion>

<Accordion title="What kind of use case scenarios can Cohere models be useful in?">

You can check the range of use cases based on our [customer stories](https://cohere.com/use-cases). 
...
Please check our [deployment options](https://cohere.com/deployment-options) and contact our sales team [with this form](https://cohere.com/contact-sales) to learn more.
...
Trial API key usage is free, [but limited](https://docs.cohere.com/docs/rate-limits). You can test different applications or build proofs of concept using all of Cohere’s models and APIs with a trial key by simply [signing up for a Cohere account](https://dashboard.cohere.com/welcome/register).
...
You can find the documentation with the full Cohere model and feature overview on the [Cohere docsite](https://docs.cohere.com/).
...
In terms of usage guidelines, we've compiled a comprehensive set of resources to ensure a smooth and compliant experience. You can access [these guidelines](https://docs.cohere.com/docs/usage-guidelines).
...
You can access all the necessary tools and information through [your account's dashboard](https://dashboard.cohere.com/team).
...
Please find the pricing information about our model and services on the [Pricing](https://cohere.com/pricing) page. 
