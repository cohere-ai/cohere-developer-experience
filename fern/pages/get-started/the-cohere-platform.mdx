...
Visit the [LLMU](../../docs/foundation-models) to learn more about Cohere foundation models.
...
Visit the [LLMU](../../docs/serving-platform) to learn more about the Cohere serving platform.
...
Visit the [LLMU](https://cohere.com/llmu/what-is-semantic-search) to learn more about semantic search.
...
Depending on your privacy/security requirements there are a number of ways to access Cohere's models:
...
- [Model Vault](../docs/model-vault): run Cohere's models on dedicated, single-tenant infrastructure managed by Cohere. You communicate with your vault over the same API, with your workloads isolated from other tenants. For your most sensitive or regulated workloads, [Model Vault Encrypted](../docs/model-vault/encrypted) adds confidential computing, so inference runs fully encrypted and you can verify that protection through remote attestation.
