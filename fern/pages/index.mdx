...
export const LandingPageContent = ({ prefix }) => {
  const cards = [
    {
      href: `${prefix}/docs`,
      ...
      description:
        "In-depth guides on how to use our products and APIs.",
    },
    {
      href: `${prefix}/reference/about`,
  ...
  const endpoints = [
    {
      href: `${prefix}/reference/chat`,
      title: "/CHAT",
    },
    {
      href: `${prefix}/reference/embed`,
      title: "/EMBED",
    },
    {
      href: `${prefix}/reference/rerank`,
      title: "/RERANK",
    },
  ];
...
<If versions={["v1", "v1 API"]}>
  <LandingPageContent prefix="/v1" />
</If>
<If versions={["v1", "v1 API"]} not>
  <LandingPageContent prefix="" />
</If>
</llms-ignore>
