...
export const cards = [
  {
    href: "/docs",
    imgSrc: "https://files.readme.io/8da77c9-Frame_138972.png",
  ...
  },
  {
    ...
    imgSrc: "https://files.readme.io/8ff146a-Group_138977.png",
    title: "API reference",
    description:
  ...
  {
    href: "/release-notes",
    imgSrc: "https://files.readme.io/d51d176-Group_138977_1.png",
    title: "Release notes",
    description:
  ...
  {
    href: "/page/cookbooks",
    imgSrc: "https://files.readme.io/7fca92c-Group_138977_2.png",
    title: "Cookbooks",
    description:
...
<div className="m-auto max-w-[1195px] flex-grow overflow-y-auto px-8 pt-10 md:p-10 md:pb-14">
  <div className="flex flex-col gap-5 md:!grid md:grid-cols-2 md:gap-10 md:pb-7 lg:!grid-cols-3 lg:gap-x-8 lg:gap-y-10 lg:pb-16">
    ...
    <div className="col-span-2">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://files.readme.io/55d9cde-InfoCards.png')",
        }}
      >
        <a
        ...
        >
          <div className="flex h-full w-[420px] flex-col items-start justify-between">
            <div className="flex flex-row items-start">
              <img
                src="https://files.readme.io/9d0694c-Symbol.svg"
                alt=""
          ...
          <div className="flex h-full md:w-1/2">
            <img
              src="https://files.readme.io/64d7b4f-Group_138975.png"
              alt=""
  ...
  <div
    ...
    style={{
      backgroundImage: "url('https://files.readme.io/ddd53ed-Mask_group.png')",
    }}
  >
    <a
      href="/docs/llmu"
