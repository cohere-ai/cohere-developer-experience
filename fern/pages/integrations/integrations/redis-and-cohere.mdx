...
<img src="../../../assets/images/5ae9bbd-redis-logo.png" />
...
query_embedding = co.embed("When was she born?", input_type='search_query',as_buffer=True)
