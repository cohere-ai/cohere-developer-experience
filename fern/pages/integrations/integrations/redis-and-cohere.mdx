...
You can also visit: <a target="_blank" href="http://localhost:8001/redis-stack/browser" rel="nofollow noopener noreferrer">http://localhost:8001/redis-stack/browser</a>. The Redis GUI will show you the index in realtime.
