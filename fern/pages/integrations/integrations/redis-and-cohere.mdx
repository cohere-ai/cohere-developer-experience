...
hidden: false
description: >-
  Explore this step-by-step tutorial to learn how to integrate Cohere embeddings
  with Redis using Wikipedia articles to build a pipeline for semantic search.
