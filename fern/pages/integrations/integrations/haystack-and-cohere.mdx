...
hidden: false
description: "Haystack is an open-source LLM framework in Python by deepset for building customizable LLM applications. Cohere's integration with Haystack provides components for embedding, generation, chat, and retrieval models."
...
<img src="../../../assets/images/d82df2c-haystack-logo.png" />
