...
- LangChain Package. To install it, run `pip install langchain`. If you run into any issues or want more details, [see this doc](https://python.langchain.com/docs/get_started/installation). Additionally, run `pip install langchain-cohere` to use the Cohere integrations in LangChain and `pip install langchain-community` to use other third-party integrations.
