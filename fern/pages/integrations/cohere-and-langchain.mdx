...
hidden: false
description: "This document provides a guide on how to integrate Cohere with LangChain, covering features like basic chat functionality, retrieval augmented generation (RAG), embeddings, and reranking. It includes code examples for each feature using LangChain's modules and Cohere's API key."
