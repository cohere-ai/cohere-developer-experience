...
This chapter uses the same <a target="_blank" href="https://colab.research.google.com/github/cohere-ai/notebooks/blob/main/notebooks/Visualizing_Text_Embeddings.ipynb#scrollTo=EAo5Z9TUhee1">Colab notebook</a>, as the previous chapter.
...
The finetuning dataset (you can [get it here](https://github.com/cohere-ai/notebooks/blob/main/notebooks/data/atis-ft-3classes.csv))  contains 344 examples , consisting of three classes. Here are a few examples:
