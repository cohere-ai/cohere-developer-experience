...
Intuition and [use case examples](https://txt.cohere.com/text-classification-use-cases/)  
An example application: [toxicity detection](https://txt.cohere.com/toxicity-sms/)  
Evaluating a [classifier’s performance](https://txt.cohere.com/classification-eval-metrics/)  
