...
This chapter comes with a corresponding <a target="_blank" href="https://github.com/cohere-ai/notebooks/blob/main/notebooks/Entity_Extrcation_with_Generative_Language_Models.ipynb">codelab</a>, and we encourage you to follow it along as you read the chapter.
