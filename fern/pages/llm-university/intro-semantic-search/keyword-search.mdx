...
This chapter comes with a corresponding [Colab notebook](https://colab.research.google.com/github/cohere-ai/notebooks/blob/main/notebooks/llmu/End_To_End_Wikipedia_Search.ipynb), and we encourage you to follow it along as you read the chapter.
