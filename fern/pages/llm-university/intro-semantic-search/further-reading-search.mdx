...
- [Multilingual Movie Search](/docs/multilingual-movie-search): Build your own movie search app. As input, you describe what movie you'd like to watch, and the model suggest a list of movies that match that description, in multiple languages.
