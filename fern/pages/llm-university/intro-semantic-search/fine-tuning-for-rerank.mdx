...
---
We’ll use [Cohere’s Dashboard](https://dashboard.cohere.com/) for the code examples. Follow along in [this notebook](https://github.com/cohere-ai/notebooks/blob/main/notebooks/llmu/Fine_Tuning_for_Rerank.ipynb).
...
- `model` - We will use [`rerank-english-v3.0`](/docs/rerank-2), Cohere's newest and most powerful pre-trained model for re-ranking English language documents
