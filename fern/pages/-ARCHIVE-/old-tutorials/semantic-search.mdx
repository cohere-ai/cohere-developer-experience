...
You can find the code in the <a target="_blank" href="https://github.com/cohere-ai/notebooks/blob/main/notebooks/Basic_Semantic_Search.ipynb">notebook</a> and <a target="_blank" href="https://colab.research.google.com/github/cohere-ai/notebooks/blob/main/notebooks/Basic_Semantic_Search.ipynb">colab</a>.
