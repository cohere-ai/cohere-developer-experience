...
hidden: false 
description: "The document explains how to use the Chat API endpoint with Cohere LLMs to generate text responses in a conversational interface, including examples in Python, Java, and TypeScript. It also covers response structure, multi-turn conversations, and using `messages` to save chat history."
