...
## System Message
A system message can be optionally provided in the request. A system message is a message provided to a model at the beginning of a conversation which dictates how the model should behave throughout.
