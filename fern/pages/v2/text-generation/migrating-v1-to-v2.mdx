...
- Message structure: 
   ...
   - v2: uses a `messages` list with role-based dictionaries (`system`, `user`, `assistant`, or `tool`).

- Chat history:
   - v1: manages chat history internally and uses a `chat_history` parameter.
