...
document_chunked = [{"text": "Equipment rental in North America is predicted to “normalize” going into 2024, according to Josh Nickell, vice president of equipment rental for the American Rental Association (ARA)."},
...
# Add a preamble for additional context
...
response = co.chat(model="command-r-plus",
                   messages=[{"role": "system", "content": preamble},
                             {'role': 'user', "content": message, "documents": document_chunked}])
...
```
 [Citation(start=0, 
           ...
           text='Josh Nickell', 
           sources=[Source_Document(id='doc:1:0', document={'id': 'doc:1:0', 'text': 'Equipment rental in North America is predicted to “normalize” going into 2024, according to Josh Nickell, vice president of equipment rental for the American Rental Association (ARA).'}, type='document')]), Citation(start=14, end=63, text='vice president of the American Rental Association', sources=[Source_Document(id='doc:1:0', document={'id': 'doc:1:0', 'text': 'Equipment rental in North America is predicted to “normalize” going into 2024, according to Josh Nickell, vice president of equipment rental for the American Rental Association (ARA).'}, type='document')]), 
   Citation(start=79, 
            end=112, 
            text='equipment rental in North America', 
            sources=[Source_Document(id='doc:1:0', document={'id': 'doc:1:0', 'text': 'Equipment rental in North America is predicted to “normalize” going into 2024, according to Josh Nickell, vice president of equipment rental for the American Rental Association (ARA).'}, type='document')]), 
   Citation(start= ...
```
...
Source documents:
[0] id: doc:1:0, text: Equipment rental in North America is predicted to “normalize” going into 2024, according to Josh Nickell, vice president of equipment rental for the American Rental Association (ARA).
[1] id: doc:1:1, text: “Rental is going back to ‘normal,’ but normal means that strategy matters again - geography matters, fleet mix matters, customer type matters,” Nickell said. “In late 2020 to 2022, you just showed up with equipment and you made money.
[2] id: doc:1:2, text: “Everybody was breaking records, from the national rental chains to the smallest rental companies; everybody was having record years, and everybody was raising prices. The conversation was, ‘How much are you up?’ And now, the conversation is changing to ‘What’s my market like?’”
```
