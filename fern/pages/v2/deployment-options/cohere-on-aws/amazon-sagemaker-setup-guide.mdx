...
You can use this code to invoke Cohere's Embed v4 model on Amazon SageMaker:
...
LOR has shown an improvement in latency under various conditions, and you can find more details in our [blog post](https://aws.amazon.com/blogs/machine-learning/minimize-real-time-inference-latency-by-using-amazon-sagemaker-routing-strategies/).
