...
In this document, you learn how to use [Azure AI Foundry](https://ai.azure.com/) to deploy the Cohere Command, Embed, Rerank, and Parse models on Microsoft's Azure cloud computing platform. You can read more about Azure AI Foundry in [its documentation](https://learn.microsoft.com/en-us/azure/ai-foundry/what-is-azure-ai-foundry).
...
You can use the Cohere SDK to invoke Parse on Azure AI Foundry. Parse converts document images into structured Markdown. Resize and convert the image to WEBP first so the data URI stays under the payload limit.
