...
Pricing depends on the models you select, the instance range provisioned for your Vault, and each model’s performance requirements. Cohere manages the underlying infrastructure and scaling, and customers can choose a monthly or annual commitment.

Here's a table summarizing the available models and their respective prices:

| Model | Hardware SKU | Corresponding Performance Tier | Monthly rate (per instance) [3-mo min commit] | Annual rate (per instance) |
| --- | --- | --- | --- | --- |
| Embed 4 | 1xL4 | Small | $2,500 | $25,000 |
| Rerank 3.5 | 1xA100 | Medium | $3,250 | $32,500 |
| Rerank 4 Fast | 1xA100 | Medium | $3,250 | $32,500 |
| Rerank 4 Pro | 1xA100 | Medium | $3,250 | $32,500 |
| Rerank 4 Pro | 1xH100 | Large | $6,500 | $65,000 |
