...
Pricing depends on the models you select and each model’s performance requirements. Cohere manages the underlying infrastructure and scaling, and customers can choose a monthly or annual commitment.

Here's a table summarizing the available models and their respective prices:

| Model | Corresponding Performance Tier | Monthly rate (per instance) [3-mo min commit] | Annual rate (per instance) |
| --- | --- | --- | --- |
