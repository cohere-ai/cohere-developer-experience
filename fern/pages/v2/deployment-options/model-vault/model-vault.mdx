...
Model Vault is billed as a Cohere-managed service. Pricing depends on the models you select and each model’s performance requirements. Cohere manages the underlying infrastructure and scaling, and customers can choose between two pricing models:
