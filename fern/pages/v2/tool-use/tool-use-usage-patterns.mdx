...
Let's also use the same tool defined from the example in the previous example[[TODO - link to basic example page]].
...
flowchart TD
    ...
    B["<div style='width:150px; text-align:center; color:black;'>Assistant (tool calls)</div>"]
    C["<div style='width:150px; text-align:center; color:black;'>Tool (tool result 1)</div>"]
    D["<div style='width:150px; text-align:center; color:black;'>Tool (tool result 2)</div>"]
    E["<div style='width:150px; text-align:center; color:black;'>Tool (tool result N)</div>"]
    F["<div style='width:150px; text-align:center; color:black;'>Assistant (response)</div>"]
...
flowchart TD
    A["<div style='width:150px; text-align:center; color:black;'>User (query)</div>"]
    B["<div style='width:150px; text-align:center; color:black;'>Assistant (response)</div>"]
...
if response.message.citations:
    ...
    for citation in response.message.citations:
        ...
        print("\n")
```
The model first determines that it first needs to find out the capital city of Brazil. Using this information, it can proceed with the next step in the sequence, which is to look up the temperature of that city.

This is reflected in the model's response, where two tool calls are generated in a sequence.
...
%%{init: {'htmlLabels': true}}%%
flowchart TD
    A["<div style='width:300px; text-align:center; color:black;'>User (query)</div>"]
    B["<div style='width:300px; text-align:center; color:black;'>Assistant (tool call(s) - step 1)</div>"]
    C["<div style='width:300px; text-align:center; color:black;'>Tool (tool result(s) - step 1)</div>"]
    D["<div style='width:300px; text-align:center; color:black;'>Assistant (tool call(s) - step 2)</div>"]
    E["<div style='width:300px; text-align:center; color:black;'>Tool (tool result(s) - step 2)</div>"]
    F["<div style='width:300px; text-align:center; color:black;'>Assistant (tool call(s) - step N)</div>"]
    G["<div style='width:300px; text-align:center; color:black;'>Tool (tool result(s) - step N)</div>"]
    H["<div style='width:300px; text-align:center; color:black;'>Assistant (response)</div>"]
...
flowchart TD
    A["<div style='width:150px; text-align:center; color:black;'>User (query)</div>"]
    B["<div style='width:150px; text-align:center; color:black;'>Assistant (tool call(s))</div>"]
    C["<div style='width:150px; text-align:center; color:black;'>Tool (tool result(s))</div>"]
...
When building chatbots, we'll need to maintain the memory or state of a conversation over multiple turns. In this case, we can keep appending each turn of a conversation to the `messages` list.
...
```
Then, in the second turn, given a rather vague follow-up user message, the model correctly infers that the context of the user's message is about the weather.
...
%%{init: {'htmlLabels': true}}%%
flowchart TD
    A["<div style='width:300px; text-align:center; color:black;'>User (query) - #1</div>"]
    B["<div style='width:300px; text-align:center; color:black;'>Assistant (tool call(s) - #1)</div>"]
    C["<div style='width:300px; text-align:center; color:black;'>Tool (tool result(s) - #1)</div>"]
    D["<div style='width:300px; text-align:center; color:black;'>Assistant (response - #1)</div>"]
    E["<div style='width:300px; text-align:center; color:black;'>User (query) - #2</div>"]
    F["<div style='width:300px; text-align:center; color:black;'>Assistant (tool call(s) - #2)</div>"]
    G["<div style='width:300px; text-align:center; color:black;'>Tool (tool result(s) - #2)</div>"]
    H["<div style='width:300px; text-align:center; color:black;'>Assistant (response - #2)</div>"]
    I["<div style='width:300px; text-align:center; color:black;'>...</div>"]
