...
def search_docs(query, top_k=3):
    ...
    return [
        ...
        {
            "title": "Structured outputs",            "url": "https://docs.cohere.com/docs/structured-outputs",            "text": "Use JSON schema to define structured inputs/outputs for tools and responses.",        },
    ][:top_k]
...
tools = [
    {
        "type": "function",        "function": {
            "name": "search_docs",            "description": "Search documentation and return relevant snippets as documents.",            "parameters": {
                "type": "object",                "properties": {
                    "query": {
                        "type": "string",                        "description": "The search query to look up in the docs.",                    },
                    "top_k": {
                        "type": "integer",                        "description": "How many documents to return.",                    },
                },
                "required": ["query"],
            },
        },
...
messages = [
    {
        "role": "user",        "content": "Explain how tool use works and how to force tool usage. Please cite your sources.",    }
]
...
<CodeBlocks>
```python PYTHON
messages.append({"role": "user", "content": "How do I force tool usage?"})
