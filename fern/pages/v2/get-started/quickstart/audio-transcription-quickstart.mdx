...
curl -X POST "https://api.cohere.com/v2/audio/transcriptions" \
  ...
  -F "model=cohere-asr-2b-nov1tok-feb06-14lang-noiseaug25-reweight-ema138k" \
  -F "language=en" \
...
```bash
{"text":"I speak only one language, and it's not my own, but the poet is a man of metaphor.","usage":{"type":"duration","seconds":7}}% 
```
