...
Here's an example usage of the SDK on the Cohere platform, first creating a client, and then calling the Chat endpoint to generate text.

[[TODO - snippets from library - text gen, 4 languages, cohere platform, v2]]