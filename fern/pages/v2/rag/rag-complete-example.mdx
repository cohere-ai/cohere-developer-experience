...
Note: For simplicity, in this example, we are assuming only one query being generated. For actual implementations, multiple queries may be generated and that means you will need to perform retrieval for each query.
