...
---
This section expands on the [basic RAG usage](https://docs.cohere.com/docs/retrieval-augmented-generation-rag) by showing a more complete example which includes:
...
```python PYTHON
# Add the user query
messages = [{"role": "user", "content": "How to get to know my teammates"}]
...
messages.append({"role": "user", "content": "Are they mostly remote?"})
