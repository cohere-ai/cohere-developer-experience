...
hidden: false
description: >-
  Fine-tune classification models with Cohere's Web UI or Python SDK using custom datasets.
...
---
In this section, we will walk through how you can start training a fine-tuning model for Classification with both the [Web UI](/v2/docs/fine-tuning-with-the-web-ui) and the Python SDK.
