...
hidden: false
description: "This document provides guidelines on preparing data for fine-tuning for Rerank, including the required `jsonl` format with fields for query, relevant passages, and hard negatives. It also outlines data requirements, evaluation datasets, and creating datasets using the Python SDK."
