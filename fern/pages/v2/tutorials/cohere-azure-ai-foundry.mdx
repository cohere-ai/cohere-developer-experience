...
keywords: "Cohere, Command models, Embed models, Rerank models, Parse models, Azure AI Foundry"
---
...
In the next sections, we will go through the various use cases of using Cohere's Command, Embed, Rerank, and Parse models on Azure AI Foundry.
