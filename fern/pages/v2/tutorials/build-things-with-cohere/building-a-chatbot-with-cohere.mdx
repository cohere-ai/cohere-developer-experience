...
## Creating a custom system instruction

A conversation starts with a system instruction to help steer a chatbot’s response toward certain characteristics.
...
Further reading:
- [Documentation on system instructions](https://docs.cohere.com/docs/system-instructions)

## Starting the first conversation turn

Let's start with the first conversation turn.

Here, we are also adding a custom system instruction for generating a concise response, just to keep the outputs brief for this tutorial.
...
- How to create a custom system instruction
