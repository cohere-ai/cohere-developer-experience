...
<a target="_blank" href="https://colab.research.google.com/github/cohere-ai/notebooks/blob/main/notebooks/guides/getting-started/v2/tutorial_pt2.ipynb">Open in Colab</a>
...
The response we get back contains several fields, but for the sake of simplicity we'll focus for the moment on `message.content[0].text`:
...
- [Documentation on predictable outputs](/v2/docs/predictable-outputs)
...
response = co.chat_stream(model="command-r-plus",
                          messages=[{"role": "user", "content": message}])
...
- [Documentation on streaming responses](/v2/docs/streaming)
