...
We recommend using the v1 API for this functionality in order to leverage the `force_single_step` feature. Note: support for search query generation in v2 will be coming soon.
