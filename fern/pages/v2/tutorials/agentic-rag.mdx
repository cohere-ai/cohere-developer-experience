...
However, a standard RAG implementation struggles on more the complex type of tasks, such as when the system needs to:
...
This is where agentic RAG comes into play. In this tutorial, we'll see how agentic RAG can solve these type of tasks. 
...
This tutorial is split into six parts, with each part focusing on one use case, as follows:
