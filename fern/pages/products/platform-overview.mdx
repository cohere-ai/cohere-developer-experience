...
no-image-zoom: true
description: >-
  The Cohere Platform — guides, API reference, release notes, and cookbooks for
  building with Command, Embed, and Rerank.
---
...
export const endpoints = [
  {
    href: "/platform/reference/chat",
    title: "/CHAT",
  },
  {
    href: "/platform/reference/embed",
    title: "/EMBED",
  },
  {
    href: "/platform/reference/rerank",
    title: "/RERANK",
  },
];

<div className="landing-outer">
  <h1 className="platform-overview-heading">Cohere Platform</h1>
  <p className="p-lg platform-overview-sub">
    Build with Command, Embed, and Rerank — the core API, models, and SDKs for developing with Cohere.
  </p>
