...
slug: /page/csv-agent-cohere-langchain-migration

description: "This page contains a tutorial on how to build CSV agent that can be used as a replacement for the create_csv_agent provided which is now sunset from the langchain-cohere package version 0.3.5 onwards."
