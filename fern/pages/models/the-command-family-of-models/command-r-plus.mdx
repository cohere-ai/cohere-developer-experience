...
These refreshed models were trained with data through February 2023, which means if you ask them questions requiring information from after this date their answers will be incorrect. But our [retrieval-augmented generation](https://docs.cohere.com/docs/retrieval-augmented-generation-rag) (RAG) functionality can connect to the internet or other sources of information, which will give the models access to more timely and relevant facts and can improve the quality of their output.
