...
hidden: false
description: >-
    Command A Reasoning is Cohere's first reasoning model excelling in tool use, agentic workflows, and complex problem-solving. It has 111 billion parameters and a 256k context length.
