...
subtitle: Command A model details and specifications
slug: docs/command-a
hidden: false
description: >-
...
const exampleModel = {
    name: 'Command A',
    description: 'Flagship model for coding, reasoning, and multimodal tasks.',
  longDescription: `Command A is a general-purpose model optimized for high-accuracy reasoning, code generation, and multimodal inputs. 

It supports tool use, structured outputs, and safe operation modes suitable for production. Use it for:

- Complex analysis and planning
- Code explanations and refactors
- Vision tasks like image understanding
- Document Q&A and summarization

Latency and cost are balanced for interactive apps while providing generous context and output limits.`,
    capabilities: [
      'Reasoning',
      'Vision',
      'Safety Modes',
    ...
    endpoints: ['Chat', 'OpenAI Chat Completions', 'Responses'],
    rateLimits: {
      'Requests per Minute': '5,000',
      'Tokens per Minute': '300,000',
      'Batch Queue Limit': '50',
    },
  };


<ModelShowcase model={exampleModel}/>
