...
hidden: false
description: >-
    Command R7B is the smallest, fastest, and final model in our R family of enterprise-focused large language models. It excels at RAG, tool use, agents, and other use cases.
