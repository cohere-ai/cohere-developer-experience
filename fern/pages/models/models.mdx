...
| `c4ai-aya-vision-32b`    | Aya Vision is a state-of-the-art multimodal large language model excelling at a variety of critical benchmarks for language, text, and image capabilities. Serves 23 languages.                  | Text, Images            | 128k                   | 4k                     | [Chat](/reference/chat)                              |
