...
- [Parse](../../docs/parse) extracts structured, machine-readable data from unstructured enterprise documents, like forms and PDFs. It powers the [Parse](../reference/parse) endpoint.
...
|-------------------------------|--------|---------------------------------------------------------------------------------------------|----------------------------------------------------------------|
| `parse-v5.0`                  | Live   | For document intelligence workloads that demand accurate, high-volume parsing               | [Parse](../reference/parse)                                                               |
