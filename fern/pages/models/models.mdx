...
|--------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-----------------------|-------------------------------------------------------------------------------------------|
| `command-r-plus-08-2024` | Command R+ 08-2024 is a refresh of the Command R+ model, delivered in August 2024. Find more information [here](LINK)                                                                                                                                                                                                                                                       | 128k           | 4k                    | [Chat](/reference/chat)                                                                                   |
| `command-r-plus`         | Command R+ is an instruction-following conversational model that performs language tasks at a higher quality, more reliably, and with a longer context than previous models. It is best suited for complex RAG workflows and multi-step tool use.                                                                                                                           | 128k           | 4k                    | [Chat](/reference/chat)                                                                                   |
| `command-r-08-2024`      | Command R 08-2024 is a refresh of the Command R model, delivered in August 2024. Find more information [here](LINK)                                                                           | 128k           | 4k                    | [Chat](/reference/chat)                                                                                   |
