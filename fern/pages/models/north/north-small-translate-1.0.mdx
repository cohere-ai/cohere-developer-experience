...
The model provides flexible deployment options for research and enterprise use. Its NVFP4 W4A16 weights are openly available
...
- **Hardware**: The suggested hardware is two H100 GPUs or one B200 GPU.
