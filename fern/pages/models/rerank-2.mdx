...
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| ---------|------------------------------|
| `rerank-v4.0-plus`         | A multilingual model that allows for re-ranking English and non-english documents and semi-structured data (JSON). This model has a context length of 32768 tokens, and is better suited for state-of-the-art quality and complex use-cases than its `light` variant.                                                   | Text     | [Rerank](/reference/rerank)  |
| `rerank-v4.0-light`        | A light version of `rerank-v4.0-plus`, this is a multilingual model that allows for re-ranking English and non-english documents and semi-structured data (JSON). This model has a context length of 32768 tokens, and is better suited for low latency and high throughput use-cases than its `plus` variant.          | Text     | [Rerank](/reference/rerank)  |
