...
- **Flexible deployment**: Available through the free-tier Chat V2 API and as NVFP4 W4A16 open weights for
  non-commercial use.
...
- **Open-weights format**: NVFP4 W4A16

## Availability

North Small Translate is available on the free tier through the [Chat V2 API](/reference/chat). The
[NVFP4 W4A16 weights](https://huggingface.co/CohereLabs/North-Small-Translate-1.0-w4a16) are available on Hugging Face
