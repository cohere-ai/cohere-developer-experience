...
Embed v4 is available today on the [Cohere Platform](https://docs.cohere.com/docs/the-cohere-platform), AWS Sagemaker, and Azure AI Foundry. For more information, check out our dedicated blog post [here]().