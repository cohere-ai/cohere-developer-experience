---
title: Cohere's Rerank v4.0 Models are Here!
slug: "changelog/rerank-v4.0"
createdAt: "Thu Dec 11 2025 13:13:00 (MST)"
hidden: false
description: >-
  Release announcement for two variants of Rerank 4.0 - our new state of the art models for ranking.
---
...
- **Two model variants available:**
  - `rerank-v4.0-pro`: Optimized for state-of-the-art quality and complex, latency-tolerant use-cases
