...
---
We're excited to introduce improvements to our Chat, Classify, Embed, and Rerank APIs in a major version upgrade, making it easier and faster to build with Cohere. We are also releasing new SDKs which feature `cohere.ClientV2` for access to the new API. 
