...
- **API endpoint**: [Audio Transcriptions API](reference/create)

## Getting started
The model is available immediately through Cohere's [Audio Transcriptions API endpoint](reference/create). 
