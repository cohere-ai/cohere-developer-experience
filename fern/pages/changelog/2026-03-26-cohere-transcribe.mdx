...
- **API endpoint**: [Audio Transcriptions API](docs/reference/audio/transcriptions/create)

## Getting started
The model is available immediately through Cohere's [Audio Transcriptions API endpoint](docs/reference/audio/transcriptions/create). 
