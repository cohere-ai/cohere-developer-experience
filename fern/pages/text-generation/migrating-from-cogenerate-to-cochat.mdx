...
The difference between Chat and Generate is that the Chat endpoint adds a default system message to the user prompt that improves the quality of the model’s output. 
