...
For more detailed breakdowns of these and other applications, check out the zip file containing our cookbooks.

Cohere models that can work with images are designed to work through an interface and API structure that looks almost exactly like all of our other Command models, making it easy to get started with our image-processing functionality straightaway. 
