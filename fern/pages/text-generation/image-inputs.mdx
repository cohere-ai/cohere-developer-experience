...
[MENTION DIFFERENT SCENARIOS WHERE IT'S USEFUL, PULL FROM ANTHROPIC COOKBOOK]
[ENTERPRISE-SPECIFIC USE CASES, parsing reports, etc., talk to Cassie.]
[TRANSLATING LANGUAGES IN AN IMAGE]
...
This turn message: `<image1> how is the image above different from the image below? <image2>`

Becomes this turn in the prompt: `<|START_TURN|>how is the image above different from the image below? <image1> <image2><|END_TURN|>`
