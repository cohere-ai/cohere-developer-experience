...
description: "This page describes how a Cohere large language model works with image inputs. It covers how to pass in an image through the API, and various limitations and best practices."
