...
- How to set safety system messages for Command A in Hugging Face
...
In the above, `{Safety Preamble}` can represent either the contextual or the strict safety mode system message, about which more below.
...
The following strict mode system message is added under the hood:
