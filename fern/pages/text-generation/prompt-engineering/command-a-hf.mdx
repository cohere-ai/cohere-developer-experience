...
Both [function calling](https://docs.cohere.com/docs/tool-use-overview) and [agents](https://docs.cohere.com/v1/docs/multi-step-tool-use) work in the same way. Given a conversation as input (with an optional preamble), along with a list of available tools, the model will generate one of the following:
