...
hidden: false
description: >-
  Cohere offers three authentication methods for connectors: Service-to-Service,
  OAuth 2.0, and Pass-Through, safeguarding your data from unauthorized access.
