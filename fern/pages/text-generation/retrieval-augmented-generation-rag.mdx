...
##### Option 2: Using a tool use approach

If you are looking for greater control over how search queries are generated, you can use the tool use approach to generate search queries.
