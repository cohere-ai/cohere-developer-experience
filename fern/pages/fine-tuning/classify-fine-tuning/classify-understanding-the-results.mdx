...
hidden: false
description: "This document explains the metrics for a fine-tuned model for Classification, including accuracy, precision, recall, and F1 scores, with examples and calculations provided for each metric."
