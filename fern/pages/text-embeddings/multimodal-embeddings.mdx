...
hidden: false
description: "Multimodal Embeddings convert text and images into numerical representations to measure similarity, useful for tasks like search and classification, with support for multiple languages and various compression types."
...
The Embed API takes in images with a file format of `png` or `jpeg`, it must then be formatted as a Data URL.
