...
In the following tables, you'll find recommendations for getting the best performance out of Rerank v3.0, v3.5, and v4.0.
...
The average of `sample_scores` can then be used as a reference when choosing a threshold for filtering out irrelevant documents.
