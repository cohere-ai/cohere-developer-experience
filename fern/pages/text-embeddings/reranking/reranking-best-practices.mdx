...
For `rerank-v3.0` and `rerank-v3.5`, the model breaks documents into 4093 token chunks. For example, if your query is 100 tokens and your document is 10,000 tokens, your document will be broken into the following chunks:
