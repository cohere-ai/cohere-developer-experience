...
hidden: false
description: "This document provides cookbooks organized by categories like 'agents,' 'Cloud,' and 'summarization' to help developers quickly get started with Cohere's functionality, including building data analyst agents, creating QA bots, performing multilingual searches, using Redis, and more."
