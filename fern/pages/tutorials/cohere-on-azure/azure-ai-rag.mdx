...
api_key_embed = "AZURE_API_KEY_EMBED"
endpoint_embed = "AZURE_ENDPOINT_EMBED" # example: "https://cohere-embed-v3-multilingual-xyz.eastus.models.ai.azure.com/"
...
Indexing complete with 133 document chunks.
```
