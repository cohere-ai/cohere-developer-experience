...
hidden: false
description: "Learn how to upgrade from a free Trial key to a Production key for using Cohere's endpoints; read about the limitations of Trial keys and the specifications of Production keys. Find the steps involved in the 'Go to Production' workflow and information on tracking incidents through Cohere's status page."
