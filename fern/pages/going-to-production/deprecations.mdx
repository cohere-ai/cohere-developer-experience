...
### 2025-04-07: Embed v2.0
On April X, 2025, we announced the release of Embed-v4.0 along with the deprecation of the Embed-v2.0 family. This does not affect any private deployment or sagemaker deployments of embed-v2.0

| Shutdown Date	| Deprecated Model	          | Deprecated Model Price	| Recommended Replacement   |
|---------------|-----------------------------|-------------------------|---------------------------|
| 2026-04-XX		| `embed-english-v2.0`	      | $0.1 / 1M Tokens	      | `embed-english-v4.0`      |
| 2026-04-XX		| `embed-english-light-v2.0`	| $0.1 / 1M Tokens	      | `embed-english-v4.0`      | 
| 2026-04-XX		| `embed-multilingual-v2.0`	  | $0.1 / 1M Tokens	      | `embed-english-v4.0`      |
