...
export const ossCards = [
  ...
  {
    title: "Migration guide for create_csv_agent langchain-cohere",
    description:
      "This notebook contains a tutorial on how to build CSV agent that can be used as a replacement for the create_csv_agent provided which is now sunset from the langchain-cohere package version 0.3.5 onwards.",
    imageSrc: "https://fern-image-hosting.s3.amazonaws.com/cohere/13cb578-Community_Demo_8.png",
    tags: ["agents", "oss", "csv],
    href: "/page/csv-agent-cohere-langchain-migration",
  },
];
...
<div className="h-[400px] md:h-[300px] w-full relative flex flex-col justify-end">
  <div
    ...
    style={{
      backgroundImage: `url(https://fern-image-hosting.s3.amazonaws.com/cohere/9bd3335-bg-apps-desktop.svg)`,
    }}
  />
  <div
    className="md:hidden absolute inset-0 -z-10 bg-cover bg-right-bottom bg-no-repeat"
    style={{
      backgroundImage: `url(https://fern-image-hosting.s3.amazonaws.com/cohere/f08bf1e-landingPage.svg)`,
    }}
  />
