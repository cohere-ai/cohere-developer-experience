...
export const ossCards = [
  ...
  },
  {
    ...
    description:
      "This page contains a tutorial on how to build a CSV agent to replace the deprecated `create_csv_agent` abstraction in langchain-cohere v0.3.5 and beyond.",
    imageSrc: "https://fern-image-hosting.s3.amazonaws.com/cohere/13cb578-Community_Demo_8.png",
    tags: ["agents", "oss", "csv"],
