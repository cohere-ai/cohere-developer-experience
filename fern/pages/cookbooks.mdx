...
export const UseCasesContainer = () => (
  <div className="all-cards-container" style={{ paddingTop: 0, paddingBottom: 0 }}>
    <div className="page-secondary-title-container">
      <div className="toc-title">
        <h3 className="h2-title" style={{ marginBottom: 12 }}>Use Cases</h3>
        <p className="p-base" style={{ marginBottom: 24 }}>
...
<div className="cookbooks-hero">
  <div
    className="cookbooks-hero-bg-desktop"
    style={{
      backgroundImage: `url(https://fern-image-hosting.s3.amazonaws.com/cohere/9bd3335-bg-apps-desktop.svg)`,
    }}
  />
  <div
    className="cookbooks-hero-bg-mobile"
    style={{
      backgroundImage: `url(https://fern-image-hosting.s3.amazonaws.com/cohere/f08bf1e-landingPage.svg)`,
    }}
  />
  <div className="cookbooks-container page-title-container">
    <h1 className="page-title dark-text" style={{ marginTop: 0, marginBottom: 24 }}>Cookbooks</h1>
    <p className="p-base page-blurb dark-text" style={{ marginBottom: 40 }}>
