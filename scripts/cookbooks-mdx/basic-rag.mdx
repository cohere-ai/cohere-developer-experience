...
<div class="cookbook-nav-container">
  ...
  <a href=https://github.com/cohere-ai/notebooks/blob/main/notebooks/Vanilla_RAG.ipynb class="github-button pt-10 group inline-block cursor-pointer font-medium " rel="noreferrer"
    target="_blank">
    Open in GitHub
